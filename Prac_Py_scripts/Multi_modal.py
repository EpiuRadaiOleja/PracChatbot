...
file_path = "./docs/Mental health policy Plans and programmes.pdf"  # Change this to your PDF path
...
def create_vector_store(documents, persist_directory="chroma_db2"):
...
db = run_complete_ingestion_pipeline("./docs/Mental health policy Plans and programmes.pdf")
